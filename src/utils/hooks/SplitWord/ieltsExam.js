import { BOLD_HIGHLIGHT_TEXT, HIGHLIGHT_TEXT, NORMAL_TEXT, detectCorrectAnswerInChoiceQuestion } from '.';
...
export function handleDetectAnswerInQuestion(paragraph) {
  ...
  if (isHaveAnswer) {
    ...
    const _answer = answers.map((answer, index) => [{ content: matches[index] + answer }]);
    return {
